...
import { Globe, ArrowRight, Loader2, Copy, Check, Sparkles } from 'lucide-react';
      ...
      <div className="glass-panel p-8 mb-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">AI Studio Translation</h1>
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            ...
            >
              {isTranslating ? <Loader2 className="w-5 h-5 animate-spin" /> : <Sparkles className="w-5 h-5 group-hover:rotate-12 transition-transform" />}
          ...
          <div className="flex-1 w-full bg-transparent overflow-y-auto text-slate-700 dark:text-slate-200 font-semibold leading-loose text-lg custom-scrollbar">
            {isTranslating ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-slate-400 opacity-50">
                ...
                <p className="font-medium text-sm">Your translation will appear here.</p>
              </div>
            )}
          </div>
        </div>
